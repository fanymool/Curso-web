    ...
    <div class="formulario">
        <form action="./dynamics/php/crearPublicación.php" method="post">
            <fieldset>
                ...
                <textarea name="descripcion" id="textaDescripcion" cols="30" rows="3" placeholder="Ingresa tu texto"
                    required></textarea>

                <h3><label for="" id="labelMeGusta"> <span>Ingresa el número de&nbsp;</span><span class="spanRojo">Me
                            gusta</span></label></h3>
